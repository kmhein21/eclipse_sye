...
ACI_2<-cbind(c(1:256),ACI_df)

ACI_3<-ACI_2|>pivot_longer(cols = c(2:11), names_to = "WAV", values_to = "ACI")|>
  mutate(WAV = as.factor(WAV))|>
...
```{r}
ggplot(data=ACI_3, aes(x=row_number(ACI_3), y=ACI))+
