...
When we plot the effects of each day we can see April 8th's flexibility. We can see a very high peak which does not appear in any of the other days, with the other days possessing some flexibilty as we expected with no major maximums or minimums. 
