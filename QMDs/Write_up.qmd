...
ggplot(data = both_days, aes(x = as_hms(time), y = Biophony, color = date(time)))+
  geom_line()+
  scale_fill_viridis_c()+
  theme_minimal()+
  labs(title = "Biophony")

ggplot(data = both_days, aes(x = as_hms(time), y = AEI, color = date(time)))+
  geom_line()+
  scale_fill_viridis_c()+
  theme_minimal()+
  labs(title = "Acoustic Evenness")

ggplot(data = both_days, aes(x = as_hms(time), y = BEI, color = date(time)))+
  geom_line()+
