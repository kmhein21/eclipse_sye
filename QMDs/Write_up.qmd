---
title: "Analyzing Changes in Audio Patterns During the 2024 Total Solar Eclipse"
...
From May 30 to April 16th, data from 20 audio recording devices was collected by Erika Barthelmess and students from the St. Lawrence Biology department. These devices were strategically located to observe potential audiological changes in wildlife across the time of the total solar eclipse on April 8th, 2024. Using R studio and a High Performance Computer, we processed this audio data to produce organized data frames, centered around 5 commonly used bioacoustic indices.From this tabular data we constructed many visualizations displaying patterns across time, day, and recording device. Due to the non-linearity present in our plots, generalized additive models based on day and recording device were implemented to assess patterns that may have occurred during the time of the eclipse. From these visuals and models, we conclude the possibility that 3 of our 5 indices are associated with audio changes during the time of the eclipse. This is highlighted by the presence of extrema around the time of totality. 
