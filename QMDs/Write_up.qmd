...
From our model output we can see that using this spline on hour by day is significant in assessing the Bioacoustic index. From looking at the estimated degrees of freedom for the smooth terms we can see that April 8th possesses the most flexible trend line with an edf of 8.774. The other days vary in their flexibility but we can see that they all do have non-linear effects with April 7th being the most flexibile, but with less than half the edf value as April 8th, at 3.632. 

We can also note from this output that the model has a explained deviance value of 10.7%, meaning that using our smoothing spline and day variable explain  10.7% of the variability in the bioacoustic index.
...
We can also see that this model has an explained deviance value of 9.1%, meaning that our model explains 9.1% of the variability in the bioacoustic index during this time frame. 
