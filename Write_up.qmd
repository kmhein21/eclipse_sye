...
Initially we approached the data set in an exploratory manner. Using a couple audiofiles (.WAV) we visualized how the indices would appear in graphics and how we should store the indices. Examples of these graphs are listed below: 
